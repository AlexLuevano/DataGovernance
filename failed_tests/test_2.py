...
def validate_data(df:pd.DataFrame, q:pd.DataFrame):
       ...
       conditions_each_fields = [
              package_level_1 & list(np.invert(each_merch_isempty)) & list(np.invert(each_ship_isempty)) & list(np.invert(each_weights_isempty)) & list(np.invert(each_gtin_isempty)) & list(np.invert(item_gtin_isempty)),
              ...
              package_level_2 & list(np.invert(each_merch_isempty)) & list(np.invert(each_ship_isempty)) & list(np.invert(each_weights_isempty)) & list(np.invert(each_gtin_isempty)) & list(np.invert(item_gtin_isempty)),
              ...
              package_level_3 & list(np.invert(each_merch_isempty)) & list(np.invert(each_ship_isempty)) & list(np.invert(each_weights_isempty)) & list(np.invert(each_gtin_isempty)) & list(np.invert(item_gtin_isempty)),
       ...
       conditions_case_fields = [
              package_level_1 & list(np.invert(case_merch_isempty)) | list(np.invert(case_ship_isempty)) | list(np.invert(case_weights_isempty)) | list(np.invert(case_gtin_isempty)),
              package_level_1 & case_gtin_isempty & case_merch_isempty & case_ship_isempty & case_weights_isempty,
              package_level_2 & list(np.invert(case_merch_isempty)) & list(np.invert(case_ship_isempty)) & list(np.invert(case_weights_isempty)) & list(np.invert(case_gtin_isempty)),
              package_level_2 & (case_gtin_isempty | case_merch_isempty | case_ship_isempty | case_weights_isempty),
              package_level_3 & list(np.invert(case_merch_isempty)) & list(np.invert(case_ship_isempty)) & list(np.invert(case_weights_isempty)) & list(np.invert(case_gtin_isempty)),
       ...
       conditions_inner_fields = [
              package_level_1 & list(np.invert(inner_merch_isempty)) | list(np.invert(inner_ship_isempty)) | list(np.invert(inner_weights_isempty)) | list(np.invert(inner_gtin_isempty)),
              package_level_1 & inner_gtin_isempty & inner_merch_isempty & inner_ship_isempty & inner_weights_isempty,
              package_level_2 & list(np.invert(inner_merch_isempty)) | list(np.invert(inner_ship_isempty)) | list(np.invert(inner_weights_isempty)) | list(np.invert(inner_gtin_isempty)),
              package_level_2 & inner_gtin_isempty & inner_merch_isempty & inner_ship_isempty & inner_weights_isempty,
              package_level_3 & list(np.invert(inner_merch_isempty)) & list(np.invert(inner_ship_isempty)) & list(np.invert(inner_weights_isempty)) & list(np.invert(inner_gtin_isempty)),
       ...
       conditions_validations = [
              ...
              package_level_1 & max_cases_pallet_layer & max_pallets & (qty_per_case_1 & ship_round_qty_1 & list(np.invert(store_order_pack_1))),
              package_level_1 & (list(np.invert(max_cases_pallet_layer)) & list(np.invert(max_pallets))) & qty_per_case_1 & ship_round_qty_1 & store_order_pack_1,
              package_level_1 & (list(np.invert(max_cases_pallet_layer)) & list(np.invert(max_pallets))) & (list(np.invert(qty_per_case_1)) & list(np.invert(ship_round_qty_1)) & list(np.invert(store_order_pack_1))),
              package_level_2 & qty_per_case_2 & ship_round_qty_2 & store_order_pack_2,
              package_level_2 & qty_per_case_2 & ship_round_qty_2 & list(np.invert(store_order_pack_2)),
              package_level_2 & qty_per_case_2 & list(np.invert(ship_round_qty_2)) & store_order_pack_2,
              package_level_2 & qty_per_case_2 & list(np.invert(ship_round_qty_2)) & list(np.invert(store_order_pack_2)),
              package_level_2 & list(np.invert(qty_per_case_2)) & ship_round_qty_2 & store_order_pack_2,
              package_level_2 & list(np.invert(qty_per_case_2)) & ship_round_qty_2 & list(np.invert(store_order_pack_2)),
              package_level_2 & list(np.invert(qty_per_case_2)) & list(np.invert(ship_round_qty_2)) & store_order_pack_2,
              package_level_2 & list(np.invert(qty_per_case_2)) & list(np.invert(ship_round_qty_2)) & list(np.invert(store_order_pack_2)),
              package_level_3 & qty_per_case_2 & ship_round_qty_3 & store_order_pack_3,
              package_level_3 & qty_per_case_2 & ship_round_qty_3 & list(np.invert(store_order_pack_3)),
              package_level_3 & qty_per_case_2 & list(np.invert(ship_round_qty_3)) & store_order_pack_3,
              package_level_3 & qty_per_case_2 & list(np.invert(ship_round_qty_3)) & list(np.invert(store_order_pack_3)),
              package_level_3 & list(np.invert(qty_per_case_2)) & ship_round_qty_3 & store_order_pack_3,
              package_level_3 & list(np.invert(qty_per_case_2)) & ship_round_qty_3 & list(np.invert(store_order_pack_3)),
              package_level_3 & list(np.invert(qty_per_case_2)) & list(np.invert(ship_round_qty_3)) & store_order_pack_3,
              package_level_3 & list(np.invert(qty_per_case_2)) & list(np.invert(ship_round_qty_3)) & list(np.invert(store_order_pack_3)),
       ]
       options_validations = [
              'Package Level 1: Ok',
       ...
       conditions_gtin = [
              ...
              package_level_1 & list(np.invert(each_gtin)),
              package_level_2 & each_gtin & case_gtin,
              package_level_2 & each_gtin & list(np.invert(case_gtin)),
              package_level_2 & list(np.invert(each_gtin)) & case_gtin,
              package_level_3 & each_gtin & case_gtin & inner_gtin & case_inner_gtin,
              package_level_3 & each_gtin & case_gtin & inner_gtin & list(np.invert(case_inner_gtin)),
              package_level_3 & each_gtin & case_gtin & list(np.invert(inner_gtin)) & case_inner_gtin,
              package_level_3 & each_gtin & case_gtin & list(np.invert(inner_gtin)) & list(np.invert(case_inner_gtin)),
              package_level_3 & each_gtin & list(np.invert(case_gtin)) & inner_gtin & case_inner_gtin,
              package_level_3 & each_gtin & list(np.invert(case_gtin)) & inner_gtin & list(np.invert(case_inner_gtin)),
              package_level_3 & each_gtin & list(np.invert(case_gtin)) & list(np.invert(inner_gtin)) & case_inner_gtin,
              package_level_3 & each_gtin & list(np.invert(case_gtin)) & list(np.invert(inner_gtin)) & list(np.invert(case_inner_gtin)),
              package_level_3 & list(np.invert(each_gtin)) & case_gtin & inner_gtin & case_inner_gtin,
              package_level_3 & list(np.invert(each_gtin)) & case_gtin & inner_gtin & list(np.invert(case_inner_gtin)),
              package_level_3 & list(np.invert(each_gtin)) & case_gtin & list(np.invert(inner_gtin)) & case_inner_gtin,
              package_level_3 & list(np.invert(each_gtin)) & case_gtin & list(np.invert(inner_gtin)) & list(np.invert(case_inner_gtin)),
              package_level_3 & list(np.invert(each_gtin)) & list(np.invert(case_gtin)) & inner_gtin & case_inner_gtin,
              package_level_3 & list(np.invert(each_gtin)) & list(np.invert(case_gtin)) & inner_gtin & list(np.invert(case_inner_gtin)),
              package_level_3 & list(np.invert(each_gtin)) & list(np.invert(case_gtin)) & list(np.invert(inner_gtin)) & case_inner_gtin,
              package_level_3 & list(np.invert(each_gtin)) & list(np.invert(case_gtin)) & list(np.invert(inner_gtin)) & list(np.invert(case_inner_gtin))
       ]
       options_gtin = [
              'Pck Lvl 1: Ok',
       ...
       conditions_weight = [
              ...
              package_level_2 & list(np.invert(case_weight_validation)),
              package_level_3 & inner_weight_validation,
              package_level_3 & list(np.invert(inner_weight_validation))
       ]
       options_weight = [
              'Package lvl 1: Ok',
              'Package lvl 2: Ok',
       ...
       conditions_volume = [
              ...
              package_level_2 & list(np.invert(case_volume_validation)),
              package_level_3 & inner_volume_validation,
              package_level_3 & list(np.invert(inner_volume_validation))
       ]
       options_volume = [
              'Package lvl 1: Ok',
              'Package lvl 2: Ok',
